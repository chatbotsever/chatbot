...
const persistent_menu = [
  {
    ...
    call_to_actions: [
      {
        title: lang.SYSTEM_MENU,
        type: 'nested',
        call_to_actions: [
          {
            title: lang.SYSTEM_MENU_CHAT,
            type: 'nested',
            call_to_actions: [
              {
                title: lang.SYSTEM_START,
                type: 'postback',
                payload: lang.KEYWORD_START
              },
              {
                title: lang.SYSTEM_FIND_MALE,
                type: 'postback',
                payload: lang.KEYWORD_GENDER + lang.KEYWORD_GENDER_MALE
              },
              {
                title: lang.SYSTEM_FIND_FEMALE,
                type: 'postback',
                payload: lang.KEYWORD_GENDER + lang.KEYWORD_GENDER_FEMALE
              },
              {
                title: lang.SYSTEM_END,
                type: 'postback',
          ...
          {
            title: lang.SYSTEM_MENU_ADMIN,
            type: 'nested',
            call_to_actions: [
              {
                title: lang.SYSTEM_ADMIN_START,
                type: 'postback',
                payload: lang.KEYWORD_ADMIN_START
              },
              {
                title: lang.SYSTEM_ADMIN_END,
                type: 'postback',
                payload: lang.KEYWORD_ADMIN_END
              }
            ]
          }
        ]
      ...
      {
        title: lang.SYSTEM_MENU_OTHER,
        type: 'nested',
        call_to_actions: [
          {
            title: lang.SYSTEM_MEOW,
            type: 'postback',
            payload: lang.KEYWORD_CAT
          },
          {
            title: lang.SYSTEM_GAUW,
            type: 'postback',
            payload: lang.KEYWORD_DOG
          },
          {
            title: lang.SYSTEM_GIRL,
            type: 'postback',
            payload: lang.KEYWORD_GIRL
          }
        ]
      },
      {
        title: lang.SYSTEM_MENU_INFO,
        type: 'nested',
        call_to_actions: [
          {
            title: lang.SYSTEM_INFO,
            type: 'postback',
            payload: lang.KEYWORD_INFO
          },
          {
            title: lang.SYSTEM_HELP,
            type: 'postback',
            payload: lang.KEYWORD_HELP
          },
          {
            title: lang.SYSTEM_REPORT,
            type: 'web_url',
            url: config.REPORT_LINK
          },
          {
            title: lang.SYSTEM_CONFESSION,
            type: 'web_url',
            url: config.CONFESSION_LINK
          }
        ]
      }
    ]
...
const setPersona = async (): Promise<void> => {
  ...
  const payload = {
    name: 'Đối chat',
    profile_picture_url: 'https://hungs20.github.io/assets/img/logo_bot.jpg'
  };
...
const sendTextButtonUrl = async (
  ...
  await sendMessage(receiver, messageData, usePersona, sender);
};
...
const sendTextButtons = async (
  ...
  if (showStartButton) {
    buttons.push({ type: 'postback', title: lang.SYSTEM_START, payload: lang.KEYWORD_START });
  }

  if (showReportButton) {
    buttons.push({ type: 'web_url', title: lang.SYSTEM_REPORT, url: config.REPORT_LINK });
  }
