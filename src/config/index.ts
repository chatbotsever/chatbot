...
export interface ConfigProps {
  ...
  NUDE_API_USER: string;
  NUDE_API_SECRET: string;
  REPORT_LINK: string;
...
export default {
  ...
  APP_NAME: parseEnvString('APP_NAME') || 'chatbotsever',
  ...
  // confess link
  CONFESSION_LINK: parseEnvString('CONFESS_LINK') || 'https://google.com',
  //nude detect api
  NUDE_API_USER: parseEnvString('NUDE_API_USER') || '',
  NUDE_API_SECRET: parseEnvString('NUDE_API_SECRET') || '',
